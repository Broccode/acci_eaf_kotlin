...
/**
 * Kommandoobjekt für die Erstellung einer neuen Rolle.
 */
data class CreateRoleCommand(
    /**
     * Name der Rolle, muss einzigartig innerhalb eines Tenants sein.
     */
    ...
    /**
     * Tenant ID für tenant-spezifische Rollen, oder null für systemweite Rollen.
     * Systemweite Rollen können nur von EAF-Administratoren erstellt werden.
     */
